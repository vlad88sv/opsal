...
<h1><?php echo _('Opciones de refinado'); ?></h1>
<table class="tabla-estandar opsal_tabla_ancha">
    <tbody>
        <tr><td><?php echo _('Clase(s)'); ?></td><td>
        ...
        <label for="clase_cualquiera"><?php echo _('Cualquier tipo'); ?></label>&nbsp;
        ...
        <tr>
            ...
            <td>
                <div id="nivel" style="text-align: center;line-height: 30px;">
                    ...
                    <label for="nivel_todos"><?php echo _('Cualquiera'); ?></label>&nbsp;        
                </div>
            </td>
        </tr>
        </tr>
...
<hr />
<h1><?php echo _('Información'); ?></h1>
<p><?php echo _('Afectados izq:'); ?> <span id="afectadosIzq"></span></p>
<p><?php echo _('Afectados der:') ?> <span id="afectadosDer"></span></p>
